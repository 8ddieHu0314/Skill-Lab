...
│  │  │ (18 checks) │  │ (4 types)   │  │ (determin.) │  │ (LLM judge) │  │   │
│  │  └─────────────┘  └─────────────┘  └─────────────┘  └─────────────┘  │   │
│  │                    │                        │                │       │   │
│  │                    └────────────┬───────────┴────────────────┘       │   │
│  │                                 ▼                                    │   │
...
|-------|-------|--------|--------------|
| **Phase 1** | Static Analysis (MVP) | **DONE** | SKILL.md parsing, 18 static checks, JSON output, CLI |
...
2. Runs 18 static checks across 4 dimensions
