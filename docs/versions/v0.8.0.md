...
- [ ] **GitHub Actions workflow template** — reusable workflow for users to run `sklab check` in CI
- [ ] **SVG badge generation** (`sklab badge`) — generate quality badges for READMEs
