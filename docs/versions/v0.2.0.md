...
```bash
sklab test-triggers ./my-skill                    # Run all trigger tests
sklab test-triggers ./my-skill --runtime codex    # Use Codex CLI
sklab test-triggers ./my-skill --runtime claude   # Use Claude CLI
sklab test-triggers ./my-skill --type explicit    # Filter by type
```
...
sklab test-triggers ./tests/fixtures/skills/testing-features --runtime codex
```
